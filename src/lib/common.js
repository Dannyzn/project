...
window.SEOData = {
    title : 'Baca - Tuan Rumah Misterius',
    description : 'Aku berhasil keluar dari rumah misterius ini, sanggupkah kamu melakukan hal yang sama?',
    url : 'http://event.baca.co.id/zombie.html',
